...
public class EmblemLibrary : ScriptableObject
{
    ...
    public string close_call_description = "Increase all Physical damage for a short time after a Perfect Dodge";
    public string arcane_remains = "Arcane Remains";
    public string arcane_remains_description = "Increase damage of all attacks when near your Remnant. Collecting your Remnant restores you to full health";
    ...
    public string confident_killer_description = "Increase the damage of all attacks when you have full health";
    ...
    public string rending_blows_description = "Heavy Attacks inflict Arcane damage over time";
    ...
    public string explosive_healing_description = "Deal Arcane damage to nearby enemies whenever you use your Healing Gem";
    ...
    public string burning_reflection_description = "Deflecting spells inflicts Arcane damage over time";
    ...
    public string _spellsword_description = "Your attacks deal extra Physical damage but consume Mana";
    ...
    public string reckless_attack_description = "Increase the damage of all attacks when you are low on health";
