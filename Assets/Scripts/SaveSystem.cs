...
{
    public static void SaveGame (string savePath, PlayerData playerData, MapData mapData, DialogueData phoneData, PlayerStats playerStats, EmblemLibrary emblemLibrary)
    {
        BinaryFormatter formatter = new BinaryFormatter();
        string path = Application.persistentDataPath + "/" + savePath + ".sav";
        FileStream stream = new FileStream(path, FileMode.Create);

        SaveData data = new SaveData(playerData, mapData, phoneData, playerStats, emblemLibrary);
