...
public class GameManager : MonoBehaviour
{
    ...
    public void LoadGame(string saveFile)
    {
        ...
        if(data != null)
        {
            ...
            playerData.unlockedKnives = playerData.GetElementsFromStrings(data.unlockedKnives);
            playerData.unlockedClaws = playerData.GetElementsFromStrings(data.unlockedClaws);
    ...
    public void StartAtFloor2()
    {
        ...
        playerData.equippedElements = new WeaponElement[4];
