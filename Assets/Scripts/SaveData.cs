...
public class SaveData
{
    ...
    public SaveData (PlayerData playerData, MapData mapData, DialogueData dialogueData, PlayerStats playerStats, EmblemLibrary emblemLibrary)
    {
        ...
        deathsToFireBoss = playerStats.deathsToEnemies.GetValueOrDefault(EnemyType.FIRE_BOSS);
        deathsToCarol = playerStats.deathsToEnemies.GetValueOrDefault(EnemyType.ELECTRIC_BOSS);
        deathsToFrank = playerStats.deathsToEnemies.GetValueOrDefault(EnemyType.ICE_BOSS);
        deathsToCeo = playerStats.deathsToEnemies.GetValueOrDefault(EnemyType.CHAOS_BOSS);
        deathsToV1 = playerStats.deathsToEnemies.GetValueOrDefault(EnemyType.MINIBOSS_V1);
        deathsToV2 = playerStats.deathsToEnemies.GetValueOrDefault(EnemyType.MINIBOSS_V2);
        deathsToV3 = playerStats.deathsToEnemies.GetValueOrDefault(EnemyType.MINIBOSS_V3);
        deathsToV4 = playerStats.deathsToEnemies.GetValueOrDefault(EnemyType.MINIBOSS_V4);
